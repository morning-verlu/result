package cn.verlu.lulu.feature.talk.presentation.auth.ui
...
import cn.verlu.lulu.feature.talk.presentation.auth.tryLaunchSyncSsoAuthorize
import cn.verlu.lulu.feature.talk.presentation.auth.vm.AuthFormViewModel
import cn.verlu.lulu.feature.talk.presentation.auth.vm.AuthMode
...
fun AuthRoute(
    ...
    val talkIconPainter = remember(context.packageName) {
