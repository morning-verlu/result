package cn.verlu.lulu.feature.cnchess.presentation.auth
...
private const val RETURN_PKG_CNCHESS = "cn.verlu.lulu"
...
fun tryLaunchSyncSsoAuthorize(context: Context, sessionId: String): Boolean {
    val uri = Uri.parse("verlusync://authorize_sso").buildUpon()
        ...
        .appendQueryParameter("returnPkg", RETURN_PKG_CNCHESS)
        .build()
