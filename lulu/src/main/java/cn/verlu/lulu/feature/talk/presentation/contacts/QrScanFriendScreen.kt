package cn.verlu.lulu.feature.talk.presentation.contacts
...
private fun ScanOverlayFriend(modifier: Modifier = Modifier) {
    Canvas(
        ...
        drawRect(color = LuluSemanticColors.scannerScrim)
        drawRoundRect(
        ...
        drawRoundRect(
            color = LuluSemanticColors.scannerFrame,
            topLeft = Offset(left, top),
            size = Size(boxSize, boxSize),
            cornerRadius = CornerRadius(24.dp.toPx()),
        ...
        val accentColor = LuluSemanticColors.scannerAccent
        listOf(
