package cn.verlu.lulu.feature.cnchess.presentation.navigation
...
import cn.verlu.lulu.feature.cnchess.presentation.auth.ui.AuthEmailRoute
import cn.verlu.lulu.feature.cnchess.presentation.auth.ui.AuthPasswordRoute
import cn.verlu.lulu.feature.cnchess.presentation.auth.ui.AuthRoute
import cn.verlu.lulu.feature.cnchess.presentation.auth.ui.UpdatePasswordDialog
import cn.verlu.lulu.feature.cnchess.presentation.auth.vm.AuthEventManager
import cn.verlu.lulu.feature.cnchess.presentation.auth.vm.AuthSessionViewModel
import cn.verlu.lulu.feature.cnchess.presentation.friends.FriendsScreen
import cn.verlu.lulu.feature.cnchess.presentation.game.GameScreen
import cn.verlu.lulu.feature.cnchess.domain.model.ChessGameStatus
import cn.verlu.lulu.feature.cnchess.domain.model.GameHistoryItem
import cn.verlu.lulu.feature.cnchess.presentation.game.ActiveGameViewModel
import cn.verlu.lulu.feature.cnchess.presentation.history.GameHistoryScreen
import cn.verlu.lulu.feature.cnchess.presentation.ui.CnChessLoadingIndicator
import cn.verlu.lulu.feature.cnchess.presentation.invite.IncomingInviteDialog
import cn.verlu.lulu.feature.cnchess.presentation.invite.InviteListenerViewModel
...
fun CnChessNavApp(
    ...
    LaunchedEffect(authState.isInitializing, authState.isAuthenticated, embeddedInLulu) {
        if (embeddedInLulu) {
            if (authState.isAuthenticated && isAuthSubFlow(backStack.lastOrNull())) {
    ...
    CompositionLocalProvider(LocalSnackbarHostState provides snackbarHostState) {
        Scaffold(
            ...
            if (!embeddedInLulu && showPasswordResetDialog) {
                ...
                entryProvider = entryProvider {
                    ...
                    entry<AppRoute.Home> {
                        ...
                        HomeRouteWithShell(
                            ...
                            showProfileAction = !embeddedInLulu,
                        )
                    }
...
private fun ProfileRouteWithShell(
    ...
    Scaffold(
        ...
        cn.verlu.lulu.feature.cnchess.presentation.profile.ProfileScreen(
            modifier = Modifier
                .fillMaxSize()
                .padding(innerPadding),
        )
