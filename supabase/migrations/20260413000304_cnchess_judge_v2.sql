-- CNChess V2 judge fields + RPC make_move_v2

alter table public.chess_moves
    add column if not exists position_hash text,
    ...
    add column if not exists judge_tag text;

alter table public.chess_games
    add column if not exists draw_reason text;
